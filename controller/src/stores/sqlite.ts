...
export type SqliteNumberValue = number | string | bigint | boolean | null | undefined;

export const toFiniteNumber = (value: SqliteNumberValue): number => {
...
export const toNullableNumber = (value: SqliteNumberValue): number | null => {
