...
export const registerRecipeRoutes = defineRoutes((app, context) => {
  ...
  return mergeRoutes(
    effectRoute.get(app, "/recipes", (ctx) =>
      Effect.gen(function* () {
    ...
    effectRoute.get(app, "/recipes/:recipeId", (ctx) =>
    ...
    effectRoute.post(app, "/recipes", (ctx) =>
      Effect.gen(function* () {
    ...
    effectRoute.put(app, "/recipes/:recipeId", (ctx) =>
      Effect.gen(function* () {
    ...
    effectRoute.delete(app, "/recipes/:recipeId", (ctx) =>
      Effect.gen(function* () {
        const recipeId = ctx.req.param("recipeId") ?? "";
