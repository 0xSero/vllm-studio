...
export const registerStudioRoutes = defineRoutes((app, context) => {
  ...
  return mergeRoutes(
    effectRoute.get(app, "/studio/settings", (ctx) =>
      buildSettingsPayload.pipe(Effect.map((payload) => ctx.json(payload))),
    ),
    effectRoute.post(app, "/studio/settings", (ctx) =>
      Effect.gen(function* () {
    ...
    effectRoute.get(app, "/studio/diagnostics", (ctx) =>
      Effect.gen(function* () {
        const cpuList = cpus();
    ...
    effectRoute.get(app, "/studio/storage", (ctx) =>
      Effect.gen(function* () {
    ...
    effectRoute.get(app, "/studio/presets", (ctx) =>
      getGpuInfo().pipe(
        Effect.map((gpus) => {
    ...
    effectRoute.post(app, "/studio/models/delete", (ctx) =>
      Effect.gen(function* () {
    ...
    effectRoute.post(app, "/studio/models/move", (ctx) =>
      Effect.gen(function* () {
