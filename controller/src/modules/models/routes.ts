...
export const registerModelsRoutes = defineRoutes((app, context) => {
  return mergeRoutes(
    effectRoute.get(app, "/v1/models", (ctx) =>
      Effect.gen(function* () {
        ...
        let activeModelData: {
          readonly data?:
            | readonly {
                readonly max_model_len?: number | undefined;
              }[]
            | undefined;
        } | null = null;
        if (current) {
    ...
    effectRoute.get(app, "/v1/models/:modelId", (ctx) =>
      Effect.gen(function* () {
    ...
    effectRoute.get(app, "/v1/studio/models", (ctx) =>
      Effect.gen(function* () {
        const recipes = yield* context.stores.recipeStore.list();
    ...
    effectRoute.get(app, "/v1/huggingface/models", (ctx) =>
      Effect.gen(function* () {
