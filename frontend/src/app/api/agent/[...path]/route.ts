...
const rules: readonly Rule[] = [
  ...
  { pattern: /^comments$/, methods: ["GET", "POST", "DELETE"], authenticated: true },
  { pattern: /^directories$/, methods: ["GET"] },
  { pattern: /^fs$/, methods: ["GET"] },
  { pattern: /^fs\/raw$/, methods: ["GET"], authenticated: true },
  { pattern: /^fs\/file$/, methods: ["GET", "PUT"], authenticated: true },
  { pattern: /^git$/, methods: ["GET", "POST"], authenticated: true },
  ...
  { pattern: /^projects$/, methods: ["GET", "POST", "DELETE"] },
  ...
  { pattern: /^terminal$/, methods: ["POST"], authenticated: true },
  { pattern: /^terminal\/resolve-cwd$/, methods: ["POST"], authenticated: true },
  {
