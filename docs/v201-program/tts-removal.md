...
| Canonical integrated head (after) | 791 | 104,378 | 4,152 |

`SUM` rows: before `791,SUM,8357,4166,104378`; after `791,SUM,8356,4152,104378`. The canonical integration changes documentation text, one packaging string, and removes stale speech narration from three controller comments: code LOC is unchanged, comment LOC falls by 14, and blank LOC falls by one. The row 1.2 LOC reduction itself — Scope A's 24 files / 5,569 manifest code lines (Scope B: 26 / 5,913) — landed in prior commits and is already reflected in the 104,378 base; PR #396 contributes nothing to it.
